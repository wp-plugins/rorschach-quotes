...
<?php /* A published transcript exists */ if ( 'publish' == $transcript_status ) :?>
	
	<div id"transcript-title"><span><?php _e( 'Transcript', 'inkblot' ); ?></span></div>
	<div id="transcript"><?php echo $transcript; ?></div>
	
<?php /* Transcribing is allowed and no draft is awaiting moderation */ elseif ( get_option( 'comic_transcripts_allowed' ) && 'draft' != $transcript_status ) : ?>
	...
	<?php else : ?>
		...
		<?php endif; ?>
			<p><textarea rows="7" cols="40" name="transcript"><?php if ( 'pending' == $transcript_status ) echo $transcript; ?></textarea></p>
